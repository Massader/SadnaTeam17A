...
public class SetStorePolicy extends ProjectTest {
    ...
    */
    ...
    public void setItemPolicySuccess() {
        ...
        Response<Boolean> purchaseLemon0 = bridge.purchaseCart(user1Id, 18.0, address, city, country, zip, cardNumber, month, year, holder, ccv, idCard);

        Response<Boolean> addAppleToBasket0 = bridge.addItemToCart(user1Id, appleId, 6, fruitStoreId);
        Response<Boolean> purchaseApple0 = bridge.purchaseCart(user1Id, 60.0, address, city, country, zip, cardNumber, month, year, holder, ccv, idCard);
        ...
        Response<Boolean> purchaseLemon1 = bridge.purchaseCart(user1Id, 18.0, address, city, country, zip, cardNumber, month, year, holder, ccv, idCard);

        Response<Boolean> addAppleToBasket1 = bridge.addItemToCart(user1Id, appleId, 6, fruitStoreId);
        Response<Boolean> purchaseApple1 = bridge.purchaseCart(user1Id, 60.0, address, city, country, zip, cardNumber, month, year, holder, ccv, idCard);
        ...
        assertEquals(purchaseLemon1.getMessage(), "The shopping basket for store Fruit Store is not accepted by store policy", "purchase failed not because policy");
        assertEquals(purchaseApple1.getMessage(), "The shopping basket for store Fruit Store is not accepted by store policy", "purchase failed not because policy");
    }
    ...
    public void setCategoryPolicySuccess() {
        ...
        Response<Boolean> purchaseMilk0 = bridge.purchaseCart(user2Id, 6 * 5.9, address, city, country, zip, cardNumber, month, year, holder, ccv, idCard);

        Response<Boolean> addStrawberryToBasket0 = bridge.addItemToCart(user2Id, strawberryId, 6, supermarketId);
        Response<Boolean> purchaseStrawberry0 = bridge.purchaseCart(user2Id, 6 * 40,address, city, country, zip, cardNumber, month, year, holder, ccv, idCard);
        ...
        Response<Boolean> purchaseMilk1 = bridge.purchaseCart(user2Id, 6 * 5.9, address, city, country, zip, cardNumber, month, year, holder, ccv, idCard);

        Response<Boolean> addStrawberryToBasket1 = bridge.addItemToCart(user2Id, strawberryId, 6, supermarketId);
        Response<Boolean> purchaseStrawberry1 = bridge.purchaseCart(user2Id, 6 * 40, address, city, country, zip, cardNumber, month, year, holder, ccv, idCard);
        ...
        assertEquals(purchaseMilk1.getMessage(), "The shopping basket for store Super Mazuz is not accepted by store policy", "purchase failed not because policy");
        assertEquals(purchaseStrawberry1.getMessage(), "The shopping basket for store Super Mazuz is not accepted by store policy", "purchase failed not because policy");
    }

    @Test
    public void setBasketPolicySuccess() {
        Response<Boolean> addTeslaToBasket0 = bridge.addItemToCart(user3Id, teslaId, 1, carStoreId);
        Response<Boolean> purchaseTesla0 = bridge.purchaseCart(user3Id, 200000.0, address, city, country, zip, cardNumber, month, year, holder, ccv, idCard);
        ...
        Response<Boolean> purchaseTesla1 = bridge.purchaseCart(user3Id, 200000.0, address, city, country, zip, cardNumber, month, year, holder, ccv, idCard);
        ...
        assertEquals(purchaseTesla1.getMessage(), "The shopping basket for store Car Store is not accepted by store policy", "purchase failed not because policy");
    }
}
